...
classes =["lays_chips","pacific_cookie","mengniu_pure_milk","vinda_tissue","lays_cup_chips","oreo_cookie","tang_powder_drink","caltrate","pantene_shampoo","sausage","baby_teether","sanxiao_toothbrush","darlie_toothpaste","pepsi_coke","orange","poems_book"]
